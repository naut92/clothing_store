...
('clothes 1', 42, '1 009.00 руб.', 'red', 'dress', 'loren ipsum123'),
('clothes 2', 43, '2 100.00 руб.', 'black', 'pants', 'is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s'),
...
('clothes 8', 52, '3 381.00 руб.', 'red', 'shirt', 'All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks as necessary, making this the first true generator on the Internet.'),
('clothes 9', 47, '1 200.00 руб.', 'red', 'shirt', 'tend to repeat predefined chunks as necessary, making this the first true generator on the.');
